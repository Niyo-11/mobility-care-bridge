export type TranslationKey = 
  ...
  | 'home.stats.peopleCount'
  | 'home.stats.aidsCount'
  | 'home.stats.partnersCount'
  | 'home.mission.title'
...
export const translations: Record<'en' | 'rw' | 'ha' | 'ig' | 'yo', Record<TranslationKey, string>> = {
  en: {
    ...
    // Home Page
    'home.hero.title': 'Bridging the Gap',
    'home.hero.subtitle': 'Accessible Healthcare',
    'home.hero.description': 'Connecting Verified Sellers/Suppliers with people in need, ensuring mobility aids like wheelchairs, crutches, and prosthetics reach those who need them most.',
    ...
    'home.stats.aidsDonated': 'Mobility Aids Supplied',
    'home.stats.activePartners': 'Active Partners',
    'home.stats.peopleCount': '3+',
    'home.stats.aidsCount': '5+',
    'home.stats.partnersCount': '3+',
    ...
    'home.mission.description': 'To make safe and affordable mobility aids accessible through technology, verified healthcare partnerships, and efficient distribution networks.',
    'home.mission.seeImpact': 'See Our Impact',
    'home.community.title': 'Building Stronger Communities',
    'home.community.description': 'Every mobility aid delivered restores more than movement; it restores independence, dignity, and opportunity.',
    'home.community.impact': 'By connecting verified suppliers, healthcare partners, and underserved communities, CareBridge ensures that safe and affordable mobility aids reach the people who need them most. Through our trusted network and circular distribution model, unused equipment is transformed into lasting social impact.',
    ...
    'footer.contactEmail': 'carebridge@zohomail.com',
    'footer.copyrightPrefix': '© 2026 CareBridge.',
  ...
  rw: {
    ...
    // Home Page
    'home.hero.title': 'Gufungura Intera',
    'home.hero.subtitle': 'Kwivuza Bifatika',
    'home.hero.description': 'Guhuza abacuruza n\'abatanga serivisi bemejwe n\'abantu bakeneye ubufasha, duhagurukira ko ibikoresho byo kugenda nk\'amapine, inkongi, n\'ibice by\'umubiri bigera ku baba babikeneye.',
    ...
    'home.mission.description': 'Gufasha ibikoresho byo kugenda byizewe kandi bihendutse kuboneka binyuze mu tekinoloji, ubufatanye bw\'ubuvuzi bwemejwe, n\'imiyoboro yo gutanga neza.',
    'home.mission.seeImpact': 'Reba ingaruka zacu',
    'home.community.title': 'Kubaka imitima ikomeye',
    'home.community.description': 'Buri gikoresho cyo kugenda cyoherejwe gisubiza atari kugenda gusa—kisubiza ubwigenge, icyubahiro, n\'ithubo.',
    'home.community.impact': 'Binyuze mu guhuza abatanga, abafatabuganse mu buvuzi, n\'imiturire itagira amahirwe, CareBridge ihora ibikoresho byizewe kandi bihendutse bigera ku bantu babikeneye. Binyuze mu murima wacu w\'ingenzi n\'uburyo bw\'itangwa ryongera gukoresha, ibikoresho bitakoreshejwe bihinduka ingaruka nziza ku muryango.',
  ...
  ha: {
    ...
    'home.hero.title': 'Rufin Girman Bambanci', 'home.hero.subtitle': 'Lafiyar jama\'a mai saukin shiga', 'home.hero.description': 'Muna hada masu sayarwa/masu samar da kayayyakin da aka tabbatar da su da mutanen da suke bukatar taimako, don tabbatar da kayan taimako kamar kujerun guragu da sanduna da kafa-siffa sun kai ga masu bukata.', 'home.hero.donateNow': 'Ba da kyauta yanzu', 'home.hero.learnMore': 'Kara koyo', 'home.hero.shopMarketplace': 'Sayar a kasuwa', 'home.hero.getInTouch': 'Tuntube mu', 'home.stats.peopleHelped': 'Mutanen da aka taimaka', 'home.stats.aidsDonated': 'Kayan taimakon da aka samar', 'home.stats.activePartners': 'Abokan hulda masu aiki', 'home.stats.peopleCount': '3+', 'home.stats.aidsCount': '5+', 'home.stats.partnersCount': '3+', 'home.mission.title': 'Manufarmu mai sauki', 'home.mission.subtitle': 'Mun yi imani cewa motsi bai kamata ya zama shinge ga rayuwa mai cike da jin dadi ba.', 'home.mission.description': 'Don sanar da kayan taimako masu aminci da arha ta hanyar fasaha, hadin gwiwa da masu ba da lafiya da aka tabbatar da su, da ingantattun hanyoyin rarraba.', 'home.mission.seeImpact': 'Duba tasirinmu', 'home.community.title': 'Gina al\'ummomi masu karfi', 'home.community.description': 'Kowane kayan taimakon da aka kai yana mayar da motsi kadai ba—yana mayar da \'yanci, mutunci, da damar samun nasara.', 'home.community.impact': 'Ta hanyar hada masu sayarwa, abokan hulda na lafiya, da al\'ummomin da ke bukatar taimako, CareBridge tana tabbatar da cewa kayan taimako masu aminci da arha sun kai ga mutanen da suke bukata sosai. Ta hanyar sadarwarmu ta dogaro da tsarin rarraba mai jurewa, kayayyakin da ba a amfani da su ba sun canza zuwa tasiri mai dorewa ga al\'umma.', 'home.community.meetPartners': 'Hadu da abokan huldanmu', 'home.community.nextSteps': 'Me ke gaba?',
  ...
  ig: {
    ...
    'home.hero.title': 'Imegharị Ogologo Oghere', 'marketplace.title': 'Ahịa Care Bridge', 'footer.mission': 'Ijikọ ndị mmadụ nwere mkpa mkpagharị na enyemaka na ọrụ nkwado na Nigeria na Rwanda.',
    // Adding minimal entries for build fix
    'home.hero.subtitle': 'Nlekọta ahụike na-enweta', 'home.hero.description': 'Ijikọ ndị na-ere ahịa/ndị na-enye ngwa ndị a kwadoro n\'ụzọ pụrụ iche na ndị nọ na mkpa, na-ahụ na ngwa enyemaka dịka oche ukwu, mkpịsị aka, na ihe ndozi ahụ na-erute ndị chọrọ ha kachasị.', 'home.hero.donateNow': 'Nye onyinye ugbu a', 'home.hero.learnMore': 'Mụtakwuo', 'home.hero.shopMarketplace': 'Zụrụ na ahịa', 'home.hero.getInTouch': 'Kpọtụrụ anyị', 'home.stats.peopleHelped': 'Ndị mmadụ enyere aka', 'home.stats.aidsDonated': 'Ngwa enyemaka e nyere', 'home.stats.activePartners': 'Ndị mmekọ na-arụ ọrụ', 'home.stats.peopleCount': '3+', 'home.stats.aidsCount': '5+', 'home.stats.partnersCount': '3+', 'home.mission.title': 'Ebumnobi anyị dị mfe', 'home.mission.subtitle': 'Anyị kwenyere na mkpagharị ekwesịghị ịbụ ihe mgbochi iji bie ndụ zuru oke.', 'home.mission.description': 'Ime ka ngwa enyemaka mkpagharị dị nchebe ma dị ọnụ ala dịrịrị site na teknụụzụ, mmekọrịta ahụike a kwadoro, na netwọọk nkesa zuru oke.', 'home.mission.seeImpact': 'Lee mmetụta anyị', 'home.community.title': 'Iwu obodo siri ike', 'home.community.description': 'Ọ bụla a nyefere adịghị naanị na-emegharị mgbaba—ọ na-emegharị nnwere onwe, ọdịnaya, na ohere.', 'home.community.impact': 'Site n\'ijikọ ndị na-enye ngwa, ndị mmekọ ahụike, na obodo ndị na-enweghị ohere zuru oke, CareBridge na-ahụ na ngwa enyemaka dị nchebe ma dị ọnụ ala na-erute ndị chọrọ ha kachasị. Site na netwọọk anyị a pụrụ ịtụkwasị obi na usoro nkesa na-agaghị akụ, ngwa ndị a na-ejighị eji na-agbanwe ka ha bụrụ mmetụta ọha na eze na-adịgide adịgide.', 'home.community.meetPartners': 'Zute ndị mmekọ anyị', 'home.community.nextSteps': 'Kedu ihe na-esote?',
  ...
  yo: {
    ...
    // Simplified translations for other keys 
    'home.hero.title': 'Titun Asopọ', 'marketplace.title': 'Oja Care Bridge', 'footer.mission': 'Sisopọ awọn eniyan ti o ni awọn iwulo gbigbe si awọn iranlọwọ didara ati awọn iṣẹ atilẹyin ni gbogbo Nigeria ati Rwanda.',
    // Adding minimal entries for all required keys to fix build
    'home.hero.subtitle': 'Ilera to ṣeeṣe', 'home.hero.description': 'Sisopọ awọn oniṣowo/awọn olupese ti a fọwọsi pẹlu awọn eniyan ti o nilo iranlọwọ, ṣiṣeduro pe awọn ohun elo iranlọwọ gbigbe bi awọn ijoko alaro, ọpa irin, ati awọn prosthetics de ọdọ awọn ti o nilo wọn julọ.', 'home.hero.donateNow': 'Fun ni ẹbun bayi', 'home.hero.learnMore': 'Kọ sii', 'home.hero.shopMarketplace': 'Ra ninu oja', 'home.hero.getInTouch': 'Pe wa', 'home.stats.peopleHelped': 'Awọn eniyan ti a ranṣe', 'home.stats.aidsDonated': 'Awọn ohun elo iranlọwọ ti a pese', 'home.stats.activePartners': 'Awọn alabaṣepọ to nṣiṣẹ', 'home.stats.peopleCount': '3+', 'home.stats.aidsCount': '5+', 'home.stats.partnersCount': '3+', 'home.mission.title': 'Ero wa rọrun', 'home.mission.subtitle': 'A gbagbọ pe gbigbe ko yẹ ki o jẹ idiwọ si gbigbe aye pipe.', 'home.mission.description': 'Lati ṣe awọn ohun elo iranlọwọ to ni aabo ati ti o wọ inu wọle nipasẹ imọ-ẹrọ, awọn ajọṣepọ ilera ti a fọwọsi, ati awọn nẹtiwọọki pinpin ti o ṣiṣẹ daradara.', 'home.mission.seeImpact': 'Wo ipa wa', 'home.community.title': 'Kikọ awọn agbegbe to lagbara', 'home.community.description': 'Ohun elo iranlọwọ kọọkan ti a fi ranṣẹ pada ju mimu lọ—o pada ominira, ẹwa-ara, ati anfani.', 'home.community.impact': 'Nipa sisopọ awọn olupese, awọn alabaṣepọ ilera, ati awọn agbegbe ti ko ni o to, CareBridge ṣeduro pe awọn ohun elo iranlọwọ to ni aabo ati ti o wọ inu wọle de ọdọ awọn eniyan ti o nilo wọn julọ. Nipa nẹtiwọọki wa ti a le gbẹkẹle ati awọn ilana pinpin ayipada, awọn ohun elo ti a ko lo yipada si ipa agbegbe ti o wa titi aye.', 'home.community.meetPartners': 'Pade awọn alabaṣepọ wa', 'home.community.nextSteps': 'Kini o tele?',
