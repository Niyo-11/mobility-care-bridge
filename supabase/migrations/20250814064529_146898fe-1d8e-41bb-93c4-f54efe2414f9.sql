-- Let's take a different approach - make merchant_id nullable temporarily for demo products
-- and create some sample products without merchants

ALTER TABLE public.products ALTER COLUMN merchant_id DROP NOT NULL;

-- Insert demo products without merchant requirements
...
-- Make merchant_id required again for future products
